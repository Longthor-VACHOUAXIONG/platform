...
import { View, Text, StyleSheet, Pressable, SafeAreaView, TextInput, FlatList, KeyboardAvoidingView, Platform } from 'react-native';
import { Ionicons } from '@expo/vector-icons';
import { useTranslation } from 'react-i18next';
import { colors, radius, spacing, typography } from '../theme/theme';
import { listenToMessages, sendMessage, type ChatMessage } from '../api/driverApi';
...
export default function ChatScreen({ navigation, route }: Props) {
  ...
  const send = async () => {
    ...
    try {
      ...
      // Keep the typed text in the input so the driver can retry.
